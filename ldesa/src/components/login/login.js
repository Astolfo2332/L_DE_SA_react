...
function Login({ setUser }) {
  var IconoOscuro=require("../logos/iconoOscuro.PNG")
  var iconoClaro=require("../logos/iconoClaro.PNG")
  var logoOscuro=require("../logos/logoOscuro.PNG")
  ...
  return (
    ...
    <div className="login-form form">
      <header> 
        <img src={logoOscuro} alt="LdeSA"></img>
